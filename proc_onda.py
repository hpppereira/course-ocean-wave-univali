...
def onda_tempo(t,eta,h):
	...
	# Dados de saida: sai_ondatempo = [Hs,H10,Hmin,Hmax,Hmed,Tmin,Tmax,Tmed,THmax,HTmax,Lmin,Lmax,Lmed,Cmed]
...
def onda_freq(t,eta,dspy,dspx,gl,han,h):
	...
	#
	# Dados de saida: sai_ondafreq = [hm0 tp dirtp]     $ tp - periodo de pico
	#                 									$ hm0 - altura significativa
	#                 									$ dirtp - direcao associado ao periodo de pico
	#
	#				  aannx = matriz de espectro cruzado entre (eta, dspx)
	#				  aannx = matriz de espectro cruzado entre (eta, dspy)
	#                 a1, b1 - coeficientes de fourier de 1 ordem
	#                 diraz - vetor de direcao azimutal em graus
	#
	# Funcoes chamadas: espectro.espec1
	#                   espectro.espec2
	#
	#======================================================================#
	'''
	...
	aanxny = espec2(dspx,dspy,dt,gl,han)
	...
	return sai_ondafreq, k, aannx, aanny, aanxny, a1, b1, diraz